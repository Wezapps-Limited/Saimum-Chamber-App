...
@section('title') Gallery Edit | Rancon Electronics Ltd Admin  @endsection
@section('content')
...
<div class="container-fluid">
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-body">
                           <h4 class="card-title costom-card-title mb-30">Edit New Image</h4>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-12">
                                       <div class="form-group mb-3">
                                          <label for="galleryTitle" class="costom-label">Alt Title</label>
                                          <input
                                          id="galleryTitle"
                                          name="title"
                                          value="{{@$edit->title}}"
                                    ...
                                    <div class="col-md-12">
                                       <div class="form-group mb-3">
                                          <label for="galleryTitle" class="costom-label">Sequence</label>
                                          <input
                                          id="galleryTitle"
                                          name="sequence"
                                          type="number"
                                    ...
                                    <div class="col-md-12">
                                       <div class="form-group mb-3">
                                          ...
                                          @if(@$edit->image!=null)
                                          <img id="gallery-image" src="{{asset('upload/CategoryManage/'.@$edit->image)}}" class="preview-image" alt="Profile Image">
                                          @else
