...
@section('content')
<form action="{{route('VisaMultiDelete')}}" method="post" id="formsubmit">
   @csrf
                                  ...
                                  <input type="checkbox" class="custom-control-input toggle-all-checkbox" name="selectAll" id="toggleAll">
                                   ...
                                   <input type="checkbox"  name="prints[]" id="allchec" value="{{@$l->id}}" multiple class="custom-control-input individual-checkbox">
                                            ...
                                            <td>
                                             ...
                                             <a href="{{route('VisaEdit',@$l->id)}}" class="btn waves-effect waves-light btn-rounded btn-info">
                                                Edit
                                             </a>
                                             <a href="{{route('VisaDelete',@$l->id)}}" id="delete" class="btn waves-effect waves-light btn-rounded btn-danger">
                                                Delete
                                             </a>
                                            </td>
                                        </tr>
